...
وESP32-C3 وESP32-S2 وESP32-S3 فحص الإعداد. وبعد إضافة جسر التوقيت الحالي، نجح
أيضاً البناء الكامل وتوليد firmware فعلياً لكل من ESP8266 وESP32-C3؛ وهما
يغطيان مساري إرسال ESPHome المستخدمين هنا: المرسل البرمجي في ESP8266 ووحدة
RMT العتادية في ESP32.
